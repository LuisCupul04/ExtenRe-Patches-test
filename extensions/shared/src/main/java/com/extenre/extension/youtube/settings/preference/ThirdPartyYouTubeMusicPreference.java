...
import static com.extenre.extension.shared.patches.PatchStatus.PackageNameYouTubeMusic;
...
import static com.extenre.extension.shared.utils.Utils.dipToPixels;
...
public class ThirdPartyYouTubeMusicPreference extends CustomDialogListPreference {
    ...
    private enum YouTubeMusic {
        ...
        OTHER(sf("extenre_external_downloader_other_item").toString(),
                null,
                true
        );
    ...
    protected void showDialog(@Nullable Bundle state) {
        ...
        editText.setHint(str("extenre_external_downloader_other_item_hint"));
        ...
        Pair<Dialog, LinearLayout> dialogPair = CustomDialog.create(
                ...
                () -> {
                    ...
                    if (newValue.isEmpty()) {
                        ...
                        CustomDialog.create(
                                context,
                                str("extenre_third_party_youtube_music_dialog_title"),
                                str("extenre_external_downloader_empty_warning"),
                                null,
                                null,
                                () -> {
    ...
    public static boolean showDialogIfAppIsNotInstalled(Context context, String packageName) {
        ...
        String message = music != null
                ? str("extenre_external_downloader_not_installed_warning", music.name)
                : str("extenre_external_downloader_package_not_found_warning", packageName);

        CustomDialog.create(
                context,
                str("extenre_external_downloader_not_found_title"),
                message,
                null,
                null,
                () -> {
