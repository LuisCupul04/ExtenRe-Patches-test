...
package com.extenre.patches.youtube.layout.actionbuttons

import com.extenre.patcher.patch.resourcePatch
import com.extenre.patcher.patch.stringOption
import com.extenre.patches.youtube.utils.compatibility.Constants.COMPATIBLE_PACKAGE
import com.extenre.patches.youtube.utils.patch.PatchList.CUSTOM_SHORTS_ACTION_BUTTONS
...
val shortsActionButtonsPatch = resourcePatch(
    name = CUSTOM_SHORTS_ACTION_BUTTONS.key,
    description = "${CUSTOM_SHORTS_ACTION_BUTTONS.title}: ${CUSTOM_SHORTS_ACTION_BUTTONS.summary}",
) {
