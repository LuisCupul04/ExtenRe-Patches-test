...
package com.extenre.patches.youtube.shorts.components
...
import com.extenre.patches.youtube.utils.bottomSheetMenuItemBuilderFingerprint
...
import com.extenre.patches.youtube.utils.extension.Constants.SHORTS_PATH
...
import com.extenre.patches.youtube.utils.indexOfSpannedCharSequenceInstruction
import com.extenre.patches.youtube.utils.lottie.LOTTIE_ANIMATION_VIEW_CLASS_DESCRIPTOR
import com.extenre.patches.youtube.utils.lottie.lottieAnimationViewHookPatch
import com.extenre.patches.youtube.utils.mainactivity.mainActivityResolvePatch
import com.extenre.patches.youtube.utils.navigation.addBottomBarContainerHook
import com.extenre.patches.youtube.utils.navigation.navigationBarHookPatch
import com.extenre.patches.youtube.utils.patch.PatchList.HIDE_FEED_FLYOUT_MENU
import com.extenre.patches.youtube.utils.patch.PatchList.SHORTS_COMPONENTS
import com.extenre.patches.youtube.utils.playertype.playerTypeHookPatch
import com.extenre.patches.youtube.utils.playservice.is_18_31_or_greater
...
import com.extenre.patches.youtube.utils.playservice.is_19_02_or_greater
import com.extenre.patches.youtube.utils.playservice.is_19_11_or_greater
...
import com.extenre.patches.youtube.utils.resourceid.bottomBarContainer
import com.extenre.patches.youtube.utils.resourceid.likeTapFeedbackCairo
import com.extenre.patches.youtube.utils.resourceid.reelDynRemix
import com.extenre.patches.youtube.utils.resourceid.reelDynShare
import com.extenre.patches.youtube.utils.resourceid.reelFeedbackLike
import com.extenre.patches.youtube.utils.resourceid.reelFeedbackPause
import com.extenre.patches.youtube.utils.resourceid.reelFeedbackPlay
import com.extenre.patches.youtube.utils.resourceid.reelForcedMuteButton
import com.extenre.patches.youtube.utils.resourceid.reelPlayerFooter
import com.extenre.patches.youtube.utils.resourceid.reelPlayerRightPivotV2Size
import com.extenre.patches.youtube.utils.resourceid.reelRightDislikeIcon
import com.extenre.patches.youtube.utils.resourceid.reelRightLikeIcon
import com.extenre.patches.youtube.utils.resourceid.rightComment
...
import com.extenre.patches.youtube.utils.videoIdFingerprintShorts
...
import com.extenre.patches.youtube.video.playbackstart.PLAYBACK_START_DESCRIPTOR_CLASS_DESCRIPTOR
import com.extenre.patches.youtube.video.playbackstart.playbackStartDescriptorPatch
import com.extenre.patches.youtube.video.playbackstart.playbackStartVideoIdReference
