...
package com.extenre.patches.youtube.player.overlaybuttons
...
import com.extenre.patches.youtube.utils.extension.Constants.OVERLAY_BUTTONS_PATH
import com.extenre.patches.youtube.utils.extension.Constants.UTILS_PATH
import com.extenre.patches.youtube.utils.fix.bottomui.cfBottomUIPatch
import com.extenre.patches.youtube.utils.patch.PatchList.OVERLAY_BUTTONS
    ...
    execute {
        ...
        copyResources(
            ...
            ResourceGroup(
                ...
                "extenre_repeat_button.xml",
                "extenre_mute_volume_button.xml",
            )
        )
        ...
        arrayOf(
            ...
            copyResources(
                ...
                ResourceGroup(
                    ...
                    "extenre_copy_button.png",
                    "extenre_copy_timestamp_button.png",
                    "extenre_external_download_button.png",
                    "extenre_play_all_button.png",
                    "extenre_playback_speed_dialog_button.png",
                    "extenre_volume_muted_button.png",
                    "extenre_volume_unmuted_button.png",
                    "extenre_whitelist_button.png",
                ...
                node.getAttributeNode("yt:layout_constraintRight_toLeftOf")
                    ?.let { attribute ->
                        if (attribute.textContent == "@id/fullscreen_button") {
                            attribute.textContent = "@+id/extenre_playback_speed_dialog_button"
                        }
                    }
            }
        }
            ...
            if (targetXml.exists()) {
                document("res/layout/$xmlFile").use { document ->
                    document.doRecursively loop@{ node ->
                            ...
                            ?.let { attribute ->
                                if (attribute.textContent == "@id/fullscreen_button") {
                                    attribute.textContent =
                                        "@+id/extenre_playback_speed_dialog_button"
                                }
                            }
                        ...
                        node.getAttributeNode("yt:layout_constraintBottom_toTopOf")
                            ?.let { attribute ->
                                if (attribute.textContent == "@id/quick_actions_container") {
                                    attribute.textContent =
                                        "@+id/extenre_overlay_buttons_bottom_margin"
                                }
                            }
                        ...
                        if (id.equals("@+id/extenre_overlay_buttons_bottom_margin")) {
