...
import com.extenre.patches.youtube.utils.patch.PatchList
...
internal object ResourceUtils {
    ...
    fun updatePatchStatus(patchTitle: String) {
        updatePatchStatusSettings(patchTitle, "@string/extenre_patches_included")
    }

    fun updatePatchStatusIcon(iconName: String) {
        iconType = iconName
        updatePatchStatusSettings("Icon", "@string/extenre_icon_$iconName")
    }
