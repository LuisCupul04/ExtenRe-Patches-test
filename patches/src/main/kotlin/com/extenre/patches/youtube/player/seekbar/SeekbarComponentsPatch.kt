...
package com.extenre.patches.youtube.player.seekbar
...
import com.extenre.patches.youtube.utils.patch.PatchList.SEEKBAR_COMPONENTS
import com.extenre.patches.youtube.utils.playerButtonsResourcesFingerprint
import com.extenre.patches.youtube.utils.playerButtonsVisibilityFingerprint
import com.extenre.patches.youtube.utils.playerSeekbarColorFingerprint
...
import com.extenre.patches.youtube.utils.playservice.is_19_49_or_greater
...
import com.extenre.patches.youtube.utils.resourceid.reelTimeBarPlayedColor
import com.extenre.patches.youtube.utils.resourceid.sharedResourceIdPatch
import com.extenre.patches.youtube.utils.resourceid.ytStaticBrandRed
...
import com.extenre.patches.youtube.utils.settings.ResourceUtils.restoreOldSplashAnimationIncluded
...
import com.extenre.util.inputStreamFromBundledResource
        ...
        context.document("res/drawable/resume_playback_progressbar_drawable.xml")
            .use { document ->
                ...
                val replacementNode = document.createElement(
                    "com.extenre.extension.youtube.patches.utils.ProgressBarDrawable"
                )
