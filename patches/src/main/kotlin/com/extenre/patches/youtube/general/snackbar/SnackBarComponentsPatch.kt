...
import com.extenre.patches.youtube.utils.patch.PatchList.SNACK_BAR_COMPONENTS
...
val snackBarComponentsPatch = resourcePatch(
    ...
    execute {
        ...
        val snackBarColorDark = "extenre_snack_bar_color_dark"
        val snackBarColorDarkReference = "@color/$snackBarColorDark"
        val snackBarColorLight = "extenre_snack_bar_color_light"
