...
package com.extenre.patches.music.player.components
...
import com.extenre.patches.music.utils.extension.Constants.PLAYER_CLASS_DESCRIPTOR
import com.extenre.patches.music.utils.mainactivity.mainActivityResolvePatch
import com.extenre.patches.music.utils.patch.PatchList.PLAYER_COMPONENTS
import com.extenre.patches.music.utils.pendingIntentReceiverFingerprint
...
import com.extenre.patches.music.utils.playservice.is_7_18_or_greater
...
import com.extenre.patches.music.utils.playservice.is_8_03_or_greater
...
import com.extenre.patches.music.utils.resourceid.darkBackground
import com.extenre.patches.music.utils.resourceid.miniPlayerPlayPauseReplayButton
import com.extenre.patches.music.utils.resourceid.miniPlayerViewPager
import com.extenre.patches.music.utils.resourceid.playerViewPager
import com.extenre.patches.music.utils.resourceid.sharedResourceIdPatch
import com.extenre.patches.music.utils.resourceid.tapBloomView
import com.extenre.patches.music.utils.resourceid.topEnd
import com.extenre.patches.music.utils.resourceid.topStart
...
import com.extenre.patches.music.utils.videotype.videoTypeHookPatch
...
val playerComponentsPatch = bytecodePatch(
    ...
    execute {
        ...
        addSwitchPreference(
            CategoryType.PLAYER,
            "extenre_add_miniplayer_next_button",
            "true"
        )
        addSwitchPreference(
            CategoryType.PLAYER,
            "extenre_add_miniplayer_previous_button",
            "true"
        )
        ...
        addSwitchPreference(
            CategoryType.PLAYER,
            "extenre_change_miniplayer_color",
            "true"
        )
        addSwitchPreference(
            CategoryType.PLAYER,
            "extenre_change_player_background_color",
            "false"
        )
        addPreferenceWithIntent(
            CategoryType.PLAYER,
            "extenre_custom_player_background_color_primary",
            "extenre_change_player_background_color"
        )
        addPreferenceWithIntent(
            CategoryType.PLAYER,
            "extenre_custom_player_background_color_secondary",
            "extenre_change_player_background_color"
        )
        ...
        if (is_7_25_or_greater) {
            ...
            addSwitchPreference(
                CategoryType.PLAYER,
                "extenre_change_seekbar_position",
                "false"
            )
        ...
        addSwitchPreference(
            CategoryType.PLAYER,
            "extenre_disable_miniplayer_gesture",
            "false"
        )
        addSwitchPreference(
            CategoryType.PLAYER,
            "extenre_disable_player_gesture",
            "false"
        )
        ...
        addSwitchPreference(
            CategoryType.PLAYER,
            "extenre_enable_forced_miniplayer",
            "true"
        )
        ...
        if (is_8_12_or_greater) {
            ...
            addSwitchPreference(
                CategoryType.PLAYER,
                "extenre_enable_smooth_transition_animation",
                "true"
            )
        }
        ...
        if (swipeToDismissMiniPlayer == true) {
            ...
            addSwitchPreference(
                CategoryType.PLAYER,
                "extenre_enable_swipe_to_dismiss_miniplayer",
                "true"
            )
        }
        ...
        addSwitchPreference(
            CategoryType.PLAYER,
            "extenre_enable_comments_scroll_top",
            "false"
        )
        ...
        addSwitchPreference(
            CategoryType.PLAYER,
            "extenre_enable_zen_mode",
            "false"
        )
        addSwitchPreference(
            CategoryType.PLAYER,
            "extenre_enable_zen_mode_podcast",
            "false",
            "extenre_enable_zen_mode"
        )
        ...
        addSwitchPreference(
            CategoryType.PLAYER,
            "extenre_hide_comment_channel_guidelines",
            "true"
        )
        ...
        addSwitchPreference(
            CategoryType.PLAYER,
            "extenre_hide_double_tap_overlay_filter",
            "false"
        )
        ...
        addSwitchPreference(
            CategoryType.PLAYER,
            "extenre_hide_comment_timestamp_and_emoji_buttons",
            "false"
        )
        ...
        addSwitchPreference(
            CategoryType.PLAYER,
            "extenre_hide_comments_information_button",
            "false"
        )
        ...
        if (is_8_05_or_greater) {
            addSwitchPreference(
                CategoryType.PLAYER,
                "extenre_hide_lyrics_share_button",
                "false"
            )
        }
        ...
        addSwitchPreference(
            CategoryType.PLAYER,
            "extenre_hide_fullscreen_share_button",
            "false"
        )
        ...
        addSwitchPreference(
            CategoryType.PLAYER,
            "extenre_hide_song_video_toggle",
            "false"
        )
        ...
        addSwitchPreference(
            CategoryType.PLAYER,
            "extenre_remember_shuffle_state",
            "true"
        )
        ...
        if (restoreOldCommentsPopupPanel) {
            addSwitchPreference(
                CategoryType.PLAYER,
                "extenre_restore_old_comments_popup_panels",
                "false"
            )
        }
        ...
        if (oldPlayerBackgroundFingerprint.resolvable()) {
            ...
            addSwitchPreference(
                CategoryType.PLAYER,
                "extenre_restore_old_player_background",
                "false"
            )
        }
        ...
        if (oldPlayerLayoutFingerprint.resolvable()) {
            ...
            addSwitchPreference(
                CategoryType.PLAYER,
                "extenre_restore_old_player_layout",
                "false"
            )
        }
